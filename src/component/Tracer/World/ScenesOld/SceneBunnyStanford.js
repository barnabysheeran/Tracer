...
export default class SceneBunnyStanford extends Scene {
  ...
  init() {
    ...
    // Mesh
    const CELLS = this.getMeshCells(1);
    const POSITIONS = this.getMeshPositions(1);
    ...
    // Floor
    const FLOOR_PLANE_DIMENSION_HALF = 110;
