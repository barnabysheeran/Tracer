...
export default class LightTest2 extends Scene {
  ...
  init() {
    ...
    this.addSphere(vec3.fromValues(-0.15, 0.0, 0.0), 0.02, MATERIAL_LIGHT_RED);
    ...
    this.addSphere(vec3.fromValues(0.0, 0.0, 0.0), 0.02, MATERIAL_LIGHT_GREEN);
    ...
    this.addSphere(vec3.fromValues(0.15, 0.0, 0.0), 0.02, MATERIAL_LIGHT_BLUE);
    ...
    // Floor Plane
    const FLOOR = this.addPlane(100.0, 100.0, MATERIAL_CHECKER);
